...
import { IconGauge, IconFingerprint, IconBook, IconBookmarks, IconInfoSquare } from '@tabler/icons';
...
function VerticalNavigation() {
  return (
    <Box>
      ...
      <NavLink label="Hinários" icon={<IconBook size={16} stroke={1.5} />} childrenOffset={28}>
